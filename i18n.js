const translations = {
  ru: {
    ...
    feTeamTitle: "Дизайн и команда.",
    feTeam: "Работаю над проектами в тесной связке с дизайнерами и бэкенд-командой. Воплощаю макеты Figma в адаптивный, пиксель-перфектный код, обсуждаю логику интерфейсов и добиваюсь точного совпадения с дизайном на всех этапах.",
    feStackTitle: "Стек.",
    feStack: "Строю фронтенд на современном стеке: Vue 3 с Composition API — для гибкой реактивной логики, TypeScript — для строгой типизации и предсказуемости кода, Pinia — для управления состоянием приложения. В проектах, где требуется серверный рендеринг или интеграция с CMS, использую Twig.",
    feApiTitle: "Клиент-серверное взаимодействие.",
    ...
    seoAchievements: "Функционал и достижения",
    seoStrategyTitle: "Стратегия и аналитика.",
    seoStrategy: "Проводил глубокий анализ рынка и конкурентной среды (Ahrefs, Serpstat). Собирал и кластеризовал семантическое ядро (Key Collector, Wordstat) для формирования оптимальной структуры будущих сайтов, что позволило заложить фундамент для высокого органического трафика.",
    seoDiscoveryTitle: "Управление требованиями (Product Discovery).",
    seoDiscovery: "Разрабатывал УТП и формировал полную документацию проектов. Согласовывал техническую реализацию и стек технологий с командой разработки, выступая связующим звеном между бизнес-задачами и IT-реализацией.",
    seoArtTitle: "Арт-дирекция и контент.",
  ...
  en: {
    ...
    feTeamTitle: "Design and collaboration.",
    feTeam: "Work closely with designers and the backend team. Turn Figma mockups into adaptive, pixel-perfect code, discuss interface logic, and keep the implementation aligned with the design at every stage.",
    feStackTitle: "Stack.",
    feStack: "Build the frontend on a modern stack: Vue 3 with the Composition API for flexible reactive logic, TypeScript for strict typing and predictable code, and Pinia for state management. Use Twig when server-side rendering or CMS integration is needed.",
    feApiTitle: "Client-server interaction.",
    ...
    seoAchievements: "Scope and results",
    seoStrategyTitle: "Strategy and analytics.",
    seoStrategy: "Conducted in-depth market and competitor analysis (Ahrefs, Serpstat). Collected and clustered the semantic core (Key Collector, Wordstat) to shape site structure and lay the groundwork for strong organic traffic.",
    seoDiscoveryTitle: "Requirements and Product Discovery.",
    seoDiscovery: "Developed USPs and full project documentation. Aligned technical implementation and the tech stack with the development team, bridging business goals and IT delivery.",
    seoArtTitle: "Art direction and content.",
